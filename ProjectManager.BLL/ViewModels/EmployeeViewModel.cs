...
namespace ProjectManager.BLL.ViewModels
{
    public class EmployeeViewModel
    {
        ...
        [Display(Name = "Tasks")] public ICollection<ProjectTaskViewModel> Tasks { get; set; }

        [Display(Name = "Name")] public string FullName => GetFullName();

        [Display(Name = "Name")] public string SimplifiedName => GetSimplifiedName();
