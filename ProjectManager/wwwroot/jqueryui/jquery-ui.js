            ...
            if (isMethodCall) {
                ...
                if (!this.length && options === "instance") {
                    ...
                    this.each(function() {
                        ...
                        if (!instance) {
                            return $.error(
                                `cannot call methods on ${name} prior to initialization; attempted to call method '${
                                options}'`);
                        }
        ...
        color.fn = jQuery.extend(color.prototype,
            {
                ...
                toRgbaString: function() {
                    var prefix = "rgba(";
                    const rgba = jQuery.map(this._rgba,
                        function(v, i) {
                ...
                toHslaString: function() {
                    var prefix = "hsla(";
                    const hsla = jQuery.map(this.hsla(),
                        function(v, i) {
                            if (v == null) {
                                v = i > 2 ? 1 : 0;
                            }
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectPulsate = $.effects.define("pulsate",
        ...
        function(options, done) {
            ...
            var // Showing or hiding leaves off the "last" animation
                animateTo = 0,
                i = 1;
            const queuelen = element.queue().length;
            ...
            $.ui.formResetMixin, {
                ...
                _readType: function() {
                    ...
                    if (nodeName !== "input" || !/radio|checkbox/.test(this.type)) {
                        $.error(
                            `Can't create checkboxradio on element.nodeName=${nodeName} and element.type=${this.type}`);
                    }
                },
    ...
    $.widget("ui.button",
        {
            ...
            _setOptions: function(options) {
                const newShowLabel = options.showLabel === undefined ? this.options.showLabel : options.showLabel;
    ...
    $.extend(Datepicker.prototype,
        {
            ...
            _autoSize: function(inst) {
                if (this._get(inst, "autoSize") && !inst.inline) {
                    var max, maxI, i // Ensure double digits
                        ;
            ...
            parseDate: function(format, value, settings) {
                ...
                var iFormat,
                    ...
                    getName = function(match, shortNames, longNames) {
                        var index = -1;
                        const names = $.map(lookAhead(match) ? longNames : shortNames,
                            function(v, k) {
                                return [[k, v]];
                            }).sort(function(a, b) {
                ...
                for (row = 0; row < numMonths[0]; row++) {
                    ...
                    for (col = 0; col < numMonths[1]; col++) {
                        ...
                        calender += `<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix${cornerClass
                            ...
                            /all|right/.test(cornerClass) && row === 0 ? (isRTL ? prev : next) : ""}${this
                            ._generateMonthYearHeader(inst,
                                drawMonth,
                                drawYear,
                                minDate,
                                maxDate,
                        ...
                        for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
                            ...
                            tbody = (!showWeek
                                ? ""
                                : `<td class='ui-datepicker-week-col'>${this._get(inst, "calculateWeek")(printDate)
                                }</td>`);
                                ...
                                tbody += "<td class='" +
                                    ...
                                    (otherMonth && !showOtherMonths
                                        ...
                                        (unselectable
                                            ...
                                            ? " ui-state-active"
                                            : ""}${otherMonth ? " ui-priority-secondary" : ""}' href='#'>${printDate
                                            .getDate()}</a>`)) +
    ...
    $.widget("ui.resizable",
        $.ui.mouse,
        {
            ...
            _setupHandles: function() {
                const o = this.options;
                var handle, i, n, hname, axis, that = this;
    ...
    $.ui.plugin.add("resizable",
        "alsoResize",
        {
            ...
            resize: function(event, ui) {
                ...
                $(o.alsoResize).each(function() {
                    const el = $(this);
                    var start = $(this).data("ui-resizable-alsoresize"), style = {};
            ...
            $.ui.formResetMixin, {
                        ...
                        function(index, item) {
                            ...
                            if (item.optgroup !== currentOptgroup) {
                                ...
                                that._addClass(li,
                                    ...
                                    `ui-menu-divider${item.element.parent("optgroup").prop("disabled")
                                    ? " ui-state-disabled"
                                    : ""}`);
                ...
                _documentClick: {
                    mousedown: function(event) {
                        ...
                        if (!$(event.target).closest(`.ui-selectmenu-menu, #${$.ui.escapeSelector(this.ids.button)}`)
                            .length) {
                            this.close(event);
                        }
                    }
